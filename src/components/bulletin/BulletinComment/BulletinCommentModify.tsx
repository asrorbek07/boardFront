...
import {ModifyBulletinBoardCommand, ModifyBulletinCommentCommand, ModifyBulletinPostCommand} from "~/apis";
import {NameValueList} from "@vizendjs/accent";
import {useBulletinBoardModify, useBulletinCommentModify, useBulletinPostModify} from "~/components";
...
export const BulletinCommentModify = ({
    ...
    const {
        ...
        formState: {errors},
        setValue,
    } = useForm<Partial<ModifyBulletinCommentCommand>>({
        defaultValues: {
        ...
        const onSuccess = async () => {
            const response = await modifyBulletinComment
                .mutateAsync({
                    ...
                    onSuccess: () => enqueueSnackbar("Bulletin Comment has been modified successfully", {variant: 'success'}),
                })
                .catch((e) => {
                    console.log(e)
            ...
            <form onSubmit={handleSubmit(handleMutate)}>
                ...
                <Card sx={{p: 3}}>
                    ...
                    >
                        ...
                        <LoadingButton loading={modifyBulletinComment.isLoading} variant="contained" color="primary"
                                       type={'submit'}>
                            Modify
                        </LoadingButton>
                    </Box>
